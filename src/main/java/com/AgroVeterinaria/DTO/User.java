...
public class User {
	...
	public LocalDateTime getCreatedAt() {return LocalDateTime;}
	public void setCreatedAt(LocalDateTime createdAt) {this.LocalDateTime = createdAt;}
	...
	public String toString() {
		return "User [id=" + id + ", email=" + email + ", name=" + name + ", phone=" + phone + ", password=" + password
				+ ", taxId=" + taxId + ", createdAt=" + LocalDateTime + ", addresses=" + addresses + "]";
	}
}