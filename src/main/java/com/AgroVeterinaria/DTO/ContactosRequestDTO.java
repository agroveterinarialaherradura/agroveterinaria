...
public class ContactosRequestDTO {
    ...
    private String tipo;        // "Visita Presencial", "Llamada Telefónica", "VideoLlamada"
    ...
    public ContactosRequestDTO(@NotBlank(message = "El origen es obligatorio") String origen,
            ...
            String estatus, String nombre, String mensaje, String fechaCita, String horaCita, String tipo) {
        this.origen = origen;
        this.annio = annio;
        this.mes = mes;
        this.dia = dia;
    ...
    public Integer getAnnio() { return annio; }
    public void setAnnio(Integer annio) { this.annio = annio; }
    ...
    public String toString() {
        return "ContactosRequestDTO [origen=" + origen + ", annio=" + annio + ", mes=" + mes + ", dia=" + dia
                ...
                + ", fechaCita=" + fechaCita + ", horaCita=" + horaCita + ", tipo=" + tipo + "]";
    }
}